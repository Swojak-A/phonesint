        ...
        <Row className='mt-3 mb-3'>
            <Col md={4}>
                ...
                <p className='text-muted'>
                    <strong>Phonesint</strong> is a project aimed on creating free tools to help OSInt operations involving phone number investigations.
                </p>
                <p className='text-muted'><FontAwesomeIcon icon={faOsi} /> - open source project.</p>
            </Col>
            <Col md={4} className='text-center'>
                <a href="https://github.com/Swojak-A/phonesint" target="_blank" rel="noopener noreferrer" className='text-white'>
